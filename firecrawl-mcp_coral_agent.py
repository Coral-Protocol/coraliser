...
coral_params = {
    "waitForAgents": 1,
    "agentId": "firecrawl-mcp",
    "agentDescription": "You are a firecrawl-mcp agent capable of performing comprehensive web scraping, crawling, and data extraction tasks, including structured data extraction and deep research, with the ability to handle dynamic content, geolocation settings, and various content formats."
}
