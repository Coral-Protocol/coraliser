...
coral_params = {
    "waitForAgents": 1,
    "agentId": "github",
    "agentDescription": "You are a GitHub agent capable of managing and interacting with repositories, issues, and pull requests. This includes creating, updating, and merging pull requests, commenting on issues and code, managing branches and files, as well as searching and retrieving information about repositories, users, and code scanning alerts."
}
...
async def main():
	...
	async with MultiServerMCPClient(
		connections = {
			...
			"github": {"command": 'docker', "args": ['run', '-i', '--rm', '-e', 'GITHUB_PERSONAL_ACCESS_TOKEN', 'ghcr.io/github/github-mcp-server'], "env": {"GITHUB_PERSONAL_ACCESS_TOKEN": os.getenv("GITHUB_PERSONAL_ACCESS_TOKEN")}}
		}
